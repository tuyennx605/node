/*
Postgres SQL
brew install postgresql     //sudo apt install postgresql
brew upgrade postgresql     //sudo apt upgrade postgresql
postgres --version          //psql -V

1.Start/stop DB
sudo gem install lunchy     //sudo apt install lunchy
...
// 	id    integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY,
//     hoten        varchar(40) NOT NULL CHECK (hoten <> ''),
//     namsinh 	date NOT NULL,  
//     lop        varchar(40) NOT NULL CHECK (lop <> ''),
//     diachi        varchar(40) NOT NULL CHECK (diachi <> '')  
// );